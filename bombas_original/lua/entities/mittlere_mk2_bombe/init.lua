...
function ENT:Use( activator, caller )
	...
	umsg.Start( "DrawTheMenuMKIIM", activator ) -- starts the creation of the usermessage, names the usermessage "DrawTheMenu" and sets the player to send it to as the player who used the entity.
